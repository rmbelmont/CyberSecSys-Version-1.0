...
@WebServlet({"/forms/searchMitigation"})
public class Form_13 extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
      ...
      if (termoBusca != null && !termoBusca.trim().isEmpty()) {
         resultadoBusca = this.buscarAttackMitigation(lista, termoBusca.trim());
      }
      ...
      printWriter.print("  <title>Search - Attack Mitigation</title>");
      ...
      printWriter.print("        <i class='fas fa-user-shield me-3'></i>");
      printWriter.print("        Attack Mitigation Search");
      printWriter.print("      </h1>");
      printWriter.print("    </div>");
      printWriter.print("  </div>");
      printWriter.print("  <div class='container'>");
      printWriter.print("    <div class='search-section'>");
      printWriter.print("      <form class='search-form' method='GET' action='forms/searchMitigation'>");
      ...
      printWriter.print("                 placeholder='Search for Attack Mitigation techniques (e.g., Encryption, Access Control, Antivirus)...' ");
      if (termoBusca != null) {
      ...
      printWriter.print("          Search is case-insensitive and ignores spaces. Total mitigation techniques available: ");
      ...
      if (termoBusca != null && !termoBusca.trim().isEmpty()) {
         ...
         if (((List)resultadoBusca).isEmpty()) {
            ...
            printWriter.print("        <p class='text-muted'>Try different keywords or browse all mitigation techniques below.</p>");
            printWriter.print("      </div>");
         } else {
            printWriter.print("      <div class='alert alert-success mb-4'>");
            printWriter.print("        <i class='fas fa-check-circle me-2'></i>");
            printWriter.print("        Found " + ((List)resultadoBusca).size() + " matching mitigation technique(s)");
            printWriter.print("      </div>");
            ...
            while(var8.hasNext()) {
               ...
               printWriter.print("        <i class='fas fa-user-shield me-2 text-primary'></i>");
      ...
      printWriter.print("        All Attack Mitigation Techniques");
      ...
      if (!lista.isEmpty() && !((String)lista.get(0)).startsWith("Erro")) {
         ...
         printWriter.print("        " + (lista.isEmpty() ? "No mitigation techniques available" : this.escapeHtml((String)lista.get(0))));
         printWriter.print("      </div>");
      }
   ...
   private List<String> buscarAttackMitigation(List<String> lista, String termoBusca) {
