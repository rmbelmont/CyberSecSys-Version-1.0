...
@WebServlet({"/forms/performance"})
public class Form_02 extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
      ...
      try {
         ...
         if (view != null) {
            resultado.addAll(view.getPerformanceEvaluation());
         } else {
      ...
      printWriter.print("      <h2 class='content-title'>Performance Evaluation Methods</h2>");
      if (!lista.isEmpty() && ((String)lista.get(0)).startsWith("Erro")) {
         ...
         printWriter.print("        Found " + lista.size() + " performance evaluation methods in cybersecurity information systems.");
         printWriter.print("      </div>");
         printWriter.print("      <p class='mb-4'>Performance evaluation methods include:</p>");
         if (lista.isEmpty()) {
            printWriter.print("      <div class='alert alert-warning'>");
            printWriter.print("        <i class='fas fa-exclamation-circle me-2'></i>");
            printWriter.print("        No Performance Evaluation instances found in the ontology.");
            printWriter.print("      </div>");
         } else {
