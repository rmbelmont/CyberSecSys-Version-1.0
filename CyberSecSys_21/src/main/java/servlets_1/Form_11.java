...
@WebServlet({"/forms/searchFunctions"})
public class Form_11 extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
      ...
      if (termoBusca != null && !termoBusca.trim().isEmpty()) {
         resultadoBusca = this.buscarOSAPISystemFunctions(lista, termoBusca.trim());
      }
      ...
      printWriter.print("  <title>Search - Cybersecurity Management</title>");
      ...
      printWriter.print("        <i class='fas fa-search me-3'></i>");
      printWriter.print("        OS API System Functions Search");
      printWriter.print("      </h1>");
      printWriter.print("    </div>");
      printWriter.print("  </div>");
      printWriter.print("  <div class='container'>");
      printWriter.print("    <div class='search-section'>");
      printWriter.print("      <form class='search-form' method='GET' action='forms/searchFunctions'>");
      ...
      printWriter.print("                 placeholder='Search for OS API functions (e.g., Allocate Memory, Create File)...' ");
      if (termoBusca != null) {
      ...
      printWriter.print("          Search is case-insensitive and ignores spaces. Total functions available: ");
      ...
      if (termoBusca != null && !termoBusca.trim().isEmpty()) {
         ...
         if (((List)resultadoBusca).isEmpty()) {
            ...
            printWriter.print("        <p class='text-muted'>Try different keywords or browse all functions below.</p>");
            printWriter.print("      </div>");
         } else {
            printWriter.print("      <div class='alert alert-success mb-4'>");
            printWriter.print("        <i class='fas fa-check-circle me-2'></i>");
            printWriter.print("        Found " + ((List)resultadoBusca).size() + " matching function(s)");
            printWriter.print("      </div>");
            ...
            while(var8.hasNext()) {
               ...
               printWriter.print("        <i class='fas fa-code me-2 text-primary'></i>");
      ...
      printWriter.print("        All OS API System Functions");
      ...
      if (!lista.isEmpty() && !((String)lista.get(0)).startsWith("Erro")) {
         ...
         for(Iterator var14 = lista.iterator(); var14.hasNext(); ++count) {
            String function = (String)var14.next();
            if (count % 2 == 0) {
            ...
            if (termoBusca != null && !termoBusca.trim().isEmpty() && function.toLowerCase().contains(termoBusca.toLowerCase())) {
               printWriter.print(this.highlightText(function, termoBusca));
            } else {
               printWriter.print(this.escapeHtml(function));
            }
         ...
         printWriter.print("        " + (lista.isEmpty() ? "No functions available" : this.escapeHtml((String)lista.get(0))));
         printWriter.print("      </div>");
      }
   ...
   private List<String> buscarOSAPISystemFunctions(List<String> lista, String termoBusca) {
